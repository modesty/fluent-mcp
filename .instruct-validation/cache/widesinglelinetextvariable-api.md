# Function: WideSingleLineTextVariable(config)
...
`WideSingleLineTextVariableType<string>`

Configuration for the wide single line text variable including:
...
- **validateRegex** (optional): `string | Record<'question_regex'>`
