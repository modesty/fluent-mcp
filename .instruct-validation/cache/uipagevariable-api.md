# Function: UIPageVariable(config)
...
`UIPageVariableType<'sys_ui_page', string | ExplicitKey<string> | Record<'sys_ui_page'>, string | ExplicitKey<string> | Record<'sys_ui_page'>>`

Configuration for the UI page variable including:
...
- **uiPage** (optional): `string | Record<RefTable>`
