# Function: NumericScaleVariable(config)
...
`NumericScaleVariableType<number>`

Configuration for the numeric scale variable including:
...
- **scaleMax** (optional): `number`
  Maximum value for the scale

- **scaleMin** (optional): `number`
