# Function: ContainerStartVariable(config)
...
`ContainerStartVariableType<unknown, unknown>`

Configuration for the container start variable including:
...
- **question** (optional): `string`
  Question text displayed to the user (container title) - required when displayTitle is true
