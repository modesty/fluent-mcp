# Function: RichTextLabelVariable(config)
...
`RichTextLabelVariableType<string>`

Configuration for the rich text label variable including:

**Properties:**

- **richText** (required): `string`
  Indicates this is a rich text variable type
