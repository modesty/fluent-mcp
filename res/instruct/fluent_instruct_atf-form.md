# Instructions for Fluent ATF Form API

Always reference `fluent_instruct_atf.md` and the ATF Form API specification for details.

1. Start from the shared `Test()` scaffold in `fluent_instruct_atf.md`.
2. Use only Form ATF step APIs documented in this metadata spec.
