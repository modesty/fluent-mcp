...
export const fx_configuration = Table({
    ...
    schema: {
        ...
        rate_table: TableNameColumn({
            ...
            dynamic_value_definitions: { type: 'dynamic_default' },
        }),
        ...
        conversion_date_source: FieldNameColumn({
            ...
            dynamic_value_definitions: { type: 'dependent_field', column_name: 'target_table' },
        }),
        ...
        rate_filter_rate_table_field: FieldNameColumn({
            ...
            dynamic_value_definitions: { type: 'dependent_field', column_name: 'rate_table' },
        }),
