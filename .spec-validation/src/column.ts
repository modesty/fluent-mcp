...
BooleanColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns an BooleanColumn object
...
}) // returns a ReferenceColumn object
...
DateTimeColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a DateTimeColumn object
...
IntegerColumn({
 ...
 min: 0, // number
 readOnly: false // boolean
}) // returns an IntegerColumn object
...
DecimalColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a DecimalColumn object
...
FieldNameColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a FieldNameColumn object
...
UserRolesColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a UserRolesColumn object
...
TranslatedTextColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a TranslatedTextColumn object
...
ConditionsColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a ConditionsColumn object
...
TranslatedFieldColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a TranslatedFieldColumn object
...
BasicImageColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a BasicImageColumn object
...
IntegerDateColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a IntegerDateColumn object
...
VersionColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a VersionColumn object
...
BasicDateTimeColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a BasicDateTimeColumn object
...
CalendarDateTime({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a CalendarDateTime object
...
DueDateColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a DueDateColumn object
...
ScheduleDateTimeColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a ScheduleDateTimeColumn object
...
OtherDateColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a OtherDateColumn object
...
DomainIdColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns an DomainIdColumn object
...
DomainPathColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a DomainPathColumn object
...
TableNameColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a TableNameColumn object
...
SystemClassNameColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a SystemClassNameColumn object
...
DocumentIdColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a DocumentIdColumn object
...
Password2Column({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a Password2Column object
...
NameValuePairsColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a NameValuePairsColumn object for flat key-value pair storage
...
MultiLineTextColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a MultiLineTextColumn object for multi-line text areas
...
DurationColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a DurationColumn object, use Duration() helper for default values
...
TimeColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a TimeColumn object, use Time() helper for default values
...
FieldListColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a FieldListColumn object
...
}) // returns a SlushBucketColumn object for dual-list selection interface
...
TemplateValueColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns a TemplateValueColumn object
...
ApprovalRulesColumn({
 ...
 maxLength: 0, // number
 readOnly: false // boolean
}) // returns an ApprovalRulesColumn object for approval workflow rules
